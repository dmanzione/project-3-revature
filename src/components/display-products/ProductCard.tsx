import { ShoppingCartOutlined, StarOutlined } from "@mui/icons-material";
...
import {
  ...
  apiGetAllWishlistProducts,
} from "../../remote/e-commerce-api/wishlistService";
...
const IconStar = styled.div<BackgroundColorProps>`
  ...
  height: 40px;
  border-radius: 50%;
  background-color: ${({ starClicked }) =>
    starClicked ? "lightgreen" : "white"};
...
export const ProductCard = (props: productProps) => {
  ...
  function updateQuantity(event: any) {
    setSelectedQuantity(+event.target.value > 0 ? +event.target.value : 1);
  }
